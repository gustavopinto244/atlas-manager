...
describe("file-backed post-conflict next-interval incomplete reconciliation recovery", () => {
  it("recovers through duplicate protection after incomplete post-conflict reconciliation", async () => {
    const directory = await mkdtemp(
      join(tmpdir(), "atlas-post-conflict-incomplete-recovery-"),
    );
