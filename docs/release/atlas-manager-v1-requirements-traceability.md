...
| FR-022  | RTC information                           | implemented_with_physical_gate | physical RTC observation qualification on Atlas                                   |
| FR-023  | Mock power operations                     | implemented                    | software qualification evidence and CI release gate                               |
| FR-024  | Wake-alarm scheduling                     | implemented_with_physical_gate | physical wake-alarm activation and qualification on Atlas                         |
| FR-025  | Safe shutdown routine                     | implemented_with_physical_gate | physical shutdown activation and qualification on Atlas                           |
| FR-026  | Machine operating schedule                | implemented_with_physical_gate | future persisted-policy authority decision; physical activation and qualification |
| FR-027  | Independent service and machine schedules | implemented_with_physical_gate | future physical scheduler-policy authority and integration qualification          |
...
| FR-037  | Command-line interface                    | implemented                    | software qualification evidence and CI release gate                               |
...
| ------------------------------------------------ | -------------------------- | ------------------------------------------------------------------------ |
| General administrative CLI                       | implemented                | ADR-027/031/032/034; source command inventory and operator package tests |
